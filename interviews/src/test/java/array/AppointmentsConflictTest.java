...
public class AppointmentsConflictTest {
	...
	public void test() {
		...
		Appointment a2 = new Appointment(3, 8);
		Appointment a3 = new Appointment(7, 9);
	...
	public void test2() {
		Appointment a1 = new Appointment(2, 6);
		Appointment a2 = new Appointment(7, 9);
		Appointment a3 = new Appointment(10, 15);
		List<Appointment> apps = Arrays.asList(a1, a2, a3);
	...
	public void test4() {
		...
		List<Appointment> apps = Arrays.asList(a1, a2, a3, a4);
	...
	public void test5() {
		...
		List<Appointment> apps = Arrays.asList(a5, a1, a2, a3, a4);
